...
CREATE TABLE `estado` (
  ...
  `descripcion_estado` varchar(50) DEFAULT NULL COMMENT 'descripcion de el estado',
...
CREATE TABLE `perfil` (
  ...
  `descripcion_perfil` varchar(50) NOT NULL COMMENT 'descripcion del perfil',
  `eliminado` int(11) DEFAULT 0 COMMENT 'si el registro es esliminado 1 si  esta eliminado  y 0 si el registro  no a sido eliminado',
...
CREATE TABLE `usuario` (
  ...
  `celular` varchar(30) NOT NULL COMMENT 'celular del usuario',
  ...
  `login` varchar(60) NOT NULL COMMENT 'login del usuario',
  `password` varchar(60) NOT NULL COMMENT 'password del usuario',
  `eliminado` int(11) DEFAULT 0 COMMENT 'si el registro es esliminado 1 si  esta eliminado  y 0 si el registro  no a sido eliminado',
  PRIMARY KEY (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='tabla para el manejo de usuario en el sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (4,1231231231,'ARMANDO','BONCHES','1231231231','SDFSDFSD','SDFSDFSD',2,3,2,'admin@gmail.com','1234',0),(5,1053849619,'DANIELA','GIRALDO DUQUE','3137951224','GIRALDODANIELA1296@GMAIL.COM','CARRERA 19A # 5-33',1,3,1,'admin@gmail.com','1234',0),(8,1234567890,'SOILA','MOCHA 2','1234567890','MANDAMELO@HOTMAIL.COM','MANDAMELO@HOTMAIL.COM',1,4,1,'admin@gmail.com','1234',0);
...
-- Dump completed on 2024-02-25 14:12:12
